...
## Overview
This project analyses bacterial tracking data to study the movement and population counts of a normal strain versus a mutant strain. For each recorded event, the 
